...
- セルフオーダーの機能追加に伴う、デザイン設計と実装を担当した
- AWS Lambda + API Gateway を使った Push 通知や Post API の設計・開発、テストではインフラチームと協働した

#### [既存案件] 販売時点情報管理 (POS) フロントエンド刷新プロジェクト (CakePHP/PHP)
- 複数店舗選択や、日付範囲選択などのリプレースに伴う、デザイン設計と実装を担当した
- 横櫛的なフロントエンドチーム (Max: 5 名) を立ち上げ、コーディングガイド・スタイルガイドを策定した
